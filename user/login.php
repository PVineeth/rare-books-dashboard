...
if($_POST["username"] == "admin@cs5300.com" && $_POST["password"] == "login@cs5300") {
...
<head>
  ...
  <title>CS5300 - Project 4 - Login</title>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Database Ninjas</h1>
                  </div>
                  <form name="login" class="user" action = "<?php $_PHP_SELF ?>" method="POST">
                    <div class="form-group">
                      <input type="email" class="form-control form-control-user" id="username" name="username" aria-describedby="emailHelp" placeholder="Enter Your Username">
                    </div>
                    <div class="form-group">
